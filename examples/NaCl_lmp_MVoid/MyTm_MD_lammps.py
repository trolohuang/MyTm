...
velocity	all create {T_start} 134567
...
# NVT 升温过程
#fix myNVT all npt temp {T_start} {T_end}  0.1 iso 0.0001 0.0001 0.1
...
with open("lammps.output","w") as log:
	subprocess.run(["/opt/intel/oneapi/mpi/2021.16/bin/mpirun","lmp_oneapi", "-in", lmp_in], stdout=log, stderr=log)


# ============================
# 5. Convert LAMMPS dump to XDATCAR and get thermodynamic parameters
# ============================
symbles_oputput = {1:"Na",2:"Cl"}
